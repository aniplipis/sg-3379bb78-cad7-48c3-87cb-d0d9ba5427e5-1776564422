    ...
    <section className="py-12 md:py-20 bg-gradient-to-b from-background to-muted/30">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-foreground mb-2 px-2">
            PROJEK DUIT RAYA – Live Execution Series
          </p>
          <div className="inline-block px-4 md:px-6 py-2 bg-primary/10 rounded-full border border-primary/20 mt-3 md:mt-4 mx-2">
            <p className="text-sm md:text-base lg:text-lg font-medium text-primary">Limited Time Special Training</p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col justify-center space-y-6 md:space-y-8 w-full">
                ...
                <div className="space-y-4 md:space-y-6">
                  <div className="flex items-start gap-3 md:gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm md:text-base text-muted-foreground">8 – 11 March 2026</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 md:gap-4">
                    <Clock className="h-5 w-5 md:h-6 md:w-6 text-primary flex-shrink-0 mt-1" />
                    <div>
                      <p className="font-semibold text-base md:text-lg">Time</p>
                      <p className="text-sm md:text-base text-muted-foreground">9.30 PM onwards</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 md:gap-4">
                    <MapPin className="h-5 w-5 md:h-6 md:w-6 text-primary flex-shrink-0 mt-1" />
                    <div>
                      <p className="font-semibold text-base md:text-lg">Platform</p>
                      <p className="text-sm md:text-base text-muted-foreground">Live via Zoom</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 md:gap-4">
                    <Target className="h-5 w-5 md:h-6 md:w-6 text-primary flex-shrink-0 mt-1" />
                    <div>
                      <p className="font-semibold text-base md:text-lg">Format</p>
                      <p className="text-sm md:text-base text-muted-foreground">4 Special Focused Sessions</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="bg-gradient-to-br from-primary/10 to-primary/5 border-2 border-primary/30">
              <CardContent className="p-4 md:p-6 lg:p-8">
                <p className="text-lg md:text-xl font-bold text-center mb-3 md:mb-4">This is not a theory class.</p>
            ...
            <div>
              ...
              <Card className="border-2 border-muted">
                <CardContent className="p-4 md:p-6">
                  ...
                  <p className="text-center font-bold text-base md:text-lg mt-4 md:mt-6 text-primary">This is execution training.</p>
                </CardContent>
              </Card>
            </div>
            ...
            <Card className="bg-gradient-to-br from-primary/20 to-primary/10 border-2 border-primary shadow-lg">
              <CardContent className="p-4 md:p-6 lg:p-8">
                <div className="text-center mb-3 md:mb-4">
                  <p className="text-xl md:text-2xl font-bold mb-2">🎯 NEW SPECIAL INDICATOR</p>
                  <p className="text-xs md:text-sm text-muted-foreground font-medium">(Exclusive Release)</p>
                </div>
                <p className="text-center font-semibold text-base md:text-lg mb-4 md:mb-6">
            ...
            {/* Who Should Join */}
            <div>
              <h3 className="text-xl md:text-2xl font-bold mb-3 md:mb-4">Who Should Join?</h3>
                ...
                {[
                  ...
                  <Card key={index} className="border border-muted hover:border-primary/50 transition-colors">
                    <CardContent className="p-3 md:p-4">
                      <p className="text-xs md:text-sm font-medium text-center">{item}</p>
                    </CardContent>
                  </Card>
                ))}
              </div>
            ...
            <Card className="bg-gradient-to-r from-primary to-primary/80 border-0 shadow-xl">
              <CardContent className="p-6 md:p-8 text-center">
                <p className="text-xl md:text-2xl font-bold text-primary-foreground mb-2">
                  🔥 Projek Duit Raya Starts Here
                </p>
                <p className="text-sm md:text-base text-primary-foreground/90 mb-2">This is your structured preparation for market opportunities leading into Raya.</p>
                <div className="space-y-1 mb-4 md:mb-6">
                  <p className="text-sm md:text-base text-primary-foreground font-medium">Sharpen execution.</p>
                  <p className="text-sm md:text-base text-primary-foreground font-medium">Strengthen discipline.</p>
                  <p className="text-sm md:text-base text-primary-foreground font-medium">Trade with clarity.</p>
                </div>
                <Link href="/#membership">
                  <Button 
                    size="lg" 
                    className="bg-background text-primary hover:bg-background/90 font-bold text-base md:text-lg px-8 md:px-12 py-4 md:py-6 h-auto shadow-2xl hover:scale-105 transition-all duration-300 w-full sm:w-auto"
                  >
