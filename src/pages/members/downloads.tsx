...
export default function Downloads() {
  ...
  const allEbooks = [
    ...
    { id: 4, title: "SUPER TRADER,MAKE CONSISTENT PROFITS IN GOOD AND BAD MARKETS Van K. Tharp, Ph.D", category: ["Trading Systems", "Trading Psychology"], link: "https://drive.google.com/file/d/1kZS5Ew8Jn4-0GrMF9CKLv_gDFLd-k2Gi/view?usp=drive_link" },
    { id: 5, title: "A Complete Guide to the Futures Market, Second Edition - Jack D.Schwager and Mark Etzkorn.", category: ["Futures Trading", "Technical Analysis"], link: "https://drive.google.com/file/d/1LSVUv-YFlN2x42XOE6nwWEi1LQ6k-tGG/view?usp=drive_link" },
    { id: 6, title: " Practical Guide to Swing Trading by Larry Swing", category: ["Swing Trading", "Trading Strategy"], link: "https://drive.google.com/file/d/1rv3uGV8oeLgEAcUpZrs-hKdvQkI30Ou2/view?usp=drive_link" },
    { id: 7, title: "A Man for All Markets: From Las Vegas to Wall Street, How I Beat the Dealer and the Market - Edward O. Thorp", category: ["Trading Biography", "Quantitative Trading"], link: "https://drive.google.com/file/d/1xRgaHcHm2-NRyny_NzSa0_Bs1zTtG39_/view?usp=drive_link" },
    { id: 8, title: "Advanced Stochastic Models, Risk Assessment, and Portfolio Optimization: The Ideal Risk, Uncertainty, and Performance Measures - Svetlozar T. Rachev, Stoyan V. Stoyanov, and Frank J. Fabozzi", category: ["Quantitative Trading", "Risk Management"], link: "https://drive.google.com/file/d/10Uwj6ektGUz_zVpkhdl1HNjRM-fnJKK9/view?usp=drive_link" },
    { id: 9, title: "Advanced Swing Trading Strategies to Predict, Identify, and Trade Future Market Swings - John Crane", category: ["Swing Trading", "Technical Analysis"], link: "https://drive.google.com/file/d/1HpkvnNXs73mdk4UiRFo0eJ-KPN28SCM7/view?usp=drive_link" },
    { id: 10, title: "Aerodynamic Trading - Constance M. Brown", category: ["Technical Analysis", "Trading Strategy"], link: "https://drive.google.com/file/d/1oGLyZJHGk6YUnMqgidYMiIKvxOW8Bxyk/view?usp=drive_link" },
