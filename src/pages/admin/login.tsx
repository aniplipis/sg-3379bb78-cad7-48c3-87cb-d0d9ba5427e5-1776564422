      ...
      <Card className="w-full max-w-md shadow-2xl border-red-900/20">
        ...
        <CardContent>
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full h-11 border-slate-300 dark:border-slate-600"
            onClick={handleGoogleLogin}
            disabled={loading || googleLoading}
          >
            {googleLoading ? (
              <div className="flex items-center justify-center">
                <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-slate-900 dark:border-white mr-2"></div>
                Connecting...
              </div>
            ) : (
              <>
